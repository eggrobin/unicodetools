...
<title>Unicode Utilities: Character Property Comparison</title>
...
<h1>Unicode Utilities: Character Property Comparison</h1>
...
<form name="myform" action="character.jsp" method="get">
  <%
        ...
        String a = utfParameters.getParameter("a", "\u2615", "\u2615");
        String b = utfParameters.getParameter("b", "\u2615", "\u2615");
